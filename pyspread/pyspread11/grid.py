...
#from frozen_tableview8  import Freeze_TableWidget
from frozen_tableview9  import Freeze_TableWidget
try:
    import matplotlib
...
class Grid(Freeze_TableWidget):
    ...
    def __init__(self, main_window: QMainWindow, model=None , name="Grid"):
        ...
        #self.setStyleSheet('QTableView::section {color:#004; background-color:#ddf}')
    ...
    def on_background_color(self):
        ...
        #attr_dict = AttrDict([("background-color", bg_color_rgb)])
        attr = CellAttribute(self.selection, self.table, attr_dict)
        idx_string = self._selected_idx_to_str(self.selected_idx)
