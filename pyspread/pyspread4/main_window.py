...
class MainWindow(QMainWindow):
    ...
    def __init__(self, filepath: Path = Path(),
        ...
        #GUSA self.main_window_actions = MainWindowActions(self)
        #GUSA self.main_window_toolbar_actions = MainWindowActions(self,
        #                                                     shortcuts=False)
        ...
        #GUSA self.menuBar().file_menu.history_submenu.update()

        # Update toolbar toggle checkboxes
        self.update_action_toggles()

        # Update the GUI so that everything matches the model
        #GUSA cell_attributes = self.grid.model.code_array.cell_attributes
    ...
    def _init_window(self):
        ...
        #GUSA self.main_window_actions.approve.setEnabled(False)
    ...
    def _init_widgets(self):
        ...
        #self.grid = Grid(self)
        #self.grid_2 = Grid(self)
        #self.grid_3 = Grid(self)
        #self.grid_4 = Grid(self)
        ...
        #self.grid_3.setModel(model)
        #self.grid_4.setModel(model)

        self.grid.init(model)
        self.grid_2.init(model)
        ...
        #GUSA self.macro_panel = MacroPanel(self, self.grid.model.code_array)
        ...
        #GUSA self.macro_dock.setWidget(self.macro_panel)
        ...
        #GUSA self.widgets.text_color_button.colorChanged.connect(
        #    self.grid.on_text_color)
        #GUSA self.widgets.background_color_button.colorChanged.connect(
        #    self.grid.on_background_color)
        #GUSA self.widgets.line_color_button.colorChanged.connect(
        #    self.grid.on_line_color)
        #GUSA self.widgets.font_combo.fontChanged.connect(self.grid.on_font)
        #GUSA self.widgets.font_size_combo.fontSizeChanged.connect(
    ...
    def _layout(self):
        ...
        #GUSA self.central_layout.addWidget(self.grid.table_choice)
