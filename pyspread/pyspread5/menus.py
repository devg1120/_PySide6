...
from PySide6.QtWidgets import QMenuBar, QMenu, QMainWindow, QWidget, QToolBar
...
class MenuBar(QMenuBar):
    ...
    def __init__(self, main_window: QMainWindow):
        ...
        #GUSA actions = main_window.main_window_actions

        #GUSA self.file_menu = FileMenu(self, actions)
        #GUSA self.edit_menu = EditMenu(self, actions)
        #GUSA self.view_menu = ViewMenu(self, actions)
        #GUSA self.format_menu = FormatMenu(self, actions)
        #GUSA self.macro_menu = MacroMenu(self, actions)
        #GUSA self.help_menu = HelpMenu(self, actions)

        #GUSA self.addMenu(self.file_menu)
        #GUSA self.addMenu(self.edit_menu)
        #GUSA self.addMenu(self.view_menu)
        #GUSA self.addMenu(self.format_menu)
        #GUSA self.addMenu(self.macro_menu)
        #GUSA self.addMenu(self.help_menu)
