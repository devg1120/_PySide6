...
class Freeze_TableWidget(QTableView):
    ...
    def updateSectionWidth(self, logicalIndex, oldSize, newSize):
        ...
        #    self.FrozenColUpdateSectionWidth(logicalIndex, oldSize, newSize)
        ###
    ...
    def FrozenRowUpdateSectionHeight(self, logicalIndex, oldSize, newSize):
        ...
        if logicalIndex < self.fp_y :
          ...
          self.frozenRow_TableView.setGeometry(self.frameWidth(), self.horizontalHeader().height() + self.frameWidth(), r.width() , r.height() + s)
          r = self.corner_TableView.rect()
          self.corner_TableView.setGeometry(self.verticalHeader().width(), self.horizontalHeader().height() + self.frameWidth(), r.width() , r.height()+ s)
