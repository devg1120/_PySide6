...
class MyView(QTableView):
    ...
    def selectionChanged(self, selected, deselected):
        ...
        #print("selectionChanged", self.parent)
        self.parent.set_focus_view(self)
    ...
    def resizeEvent(self, event):
        ...
        try:
            ...
            pass
    def setSpan( self, row, column, rowSpanCount,  columnSpanCount):
        super().setSpan( row,  column,  rowSpanCount,  columnSpanCount)
        self.parent.bc_setSpan( self, row,  column,  rowSpanCount,  columnSpanCount)
    def bc_setSpan( self, row, column, rowSpanCount,  columnSpanCount):
        super().setSpan( row,  column,  rowSpanCount,  columnSpanCount)
